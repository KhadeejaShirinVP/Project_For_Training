...
namespace ContractorFinding_Test.Services
{
    ...
    {
        private static DbContextOptions<ContractorFindingProContext> dbContextOptions = new DbContextOptionsBuilder<ContractorFindingProContext>()
         .UseInMemoryDatabase(databaseName: "Contractor_FindingPRO")
         .Options;
        public ContractorFindingProContext context;

        public DataFixture()
        {
            context = new ContractorFindingProContext(dbContextOptions);
