...
namespace API.Controllers
{
    ...
    {
        private readonly ContractorFindingProContext contractorFindingContext;
        ...
        //constructor
        public UserController(ContractorFindingProContext contractordemoContext, IUserService userService, IMapper mapper, IGenerateToken generateToken):base(contractordemoContext)
        {
